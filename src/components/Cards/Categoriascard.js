...
export default function Categoriacard({ ip, id_categoria, nombre_categoria, imagen_categoria }) {

    return (
        <View style={styles.categoryItems}>
            <View style={styles.categoryItem}>
                <Image
                    source={{ uri: `${ip}/sportfusion/api/images/categorias/${imagen_categoria}` }}
